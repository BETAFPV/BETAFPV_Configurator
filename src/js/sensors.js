...
sensors.initialize = function (callback) {
    ...
    $('#content').load("./src/html/sensors.html", function () {
        ...
        let debugHelpers = [
            initGraphHelpers('#debug1', samples_debug_i,[-30,30]),
            initGraphHelpers('#debug2', samples_debug_i,[-30,30]),
            initGraphHelpers('#debug3', samples_debug_i,[-100,100]),
            initGraphHelpers('#debug4', samples_debug_i,[-100,100])
        ];
