...
*/
mavlink10.messages.heartbeat = function(version, protocol) {
    ...
    this.fieldnames = ['version', 'protocol'];
...
mavlink10.messages.heartbeat.prototype.pack = function(mav) {
    return mavlink10.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.version, this.protocol]));
}


mavlink10.map = {
        0: { format: '<BB', type: mavlink10.messages.heartbeat, order_map: [0, 1], crc_extra: 52 },
}
